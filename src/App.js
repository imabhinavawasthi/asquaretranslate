    ...
    <div class="container">
      <div className="row">
        <div className="col-md-12">
          <h1 class="mt-3 position-relative">⌨️ Asquare Translate</h1>
          <div class="form-group shadow-textarea mt-4">
            <textarea onChange={setinputarea} class="form-control z-depth-1" id="exampleFormControlTextarea6" rows="5" placeholder="Write something here..."></textarea>
          </div>
          <div class="form-group" aria-label="Default select example">
            <select class="form-control" id="sel1" onChange={languagekey}>
              <option value="none" selected>Selected Desired Language</option>
          ...
          <div class="form-group shadow-textarea mt-4">
            <textarea disabled class="form-control z-depth-1" id="exampleFormControlTextarea6" rows="5" placeholder="Output" value={resulttxt}></textarea>
          </div>
